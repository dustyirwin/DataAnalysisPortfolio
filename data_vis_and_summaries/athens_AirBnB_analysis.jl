...
# ╔═╡ f25baffb-a05d-4b43-9bf2-cf5c57a3736d
using CSV, DataFramesMeta, Dates, PlutoUI, Statistics, Plots, Shapefile, ColorSchemes

# ╔═╡ 228e8deb-b257-48d5-90e4-400edbb06c69
md"""
# Athens AirBnB Rentals
"""

# ╔═╡ 164c42b2-a1ef-4b44-9e73-bf94c0398986
data = let
	df = CSV.File("data/AirBnB_listings_Athens.csv.gz") |> DataFrame
	sort!(df, [:last_review,:number_of_reviews])
	cols = [:name, :last_review,:price,:number_of_reviews]
	select(df, cols, Not(cols))
end

# ╔═╡ 07275d51-2684-41c7-9d95-d038a4f1d00b
describe(data)

# ╔═╡ 26b4f8a6-7f48-4ad9-8a7b-3509688250f6
md"""
# Appendix B
"""

# ╔═╡ 6771aa67-8108-48e7-88e5-0b5dd0f22417
space = "<br><br><br>" |> HTML

# ╔═╡ 41fe9248-4a4f-4012-bc6e-996d9b0685f6
...
# ╔═╡ 3e87a2f7-57af-49c0-b73d-437695c82aaa
PlutoUI.TableOfContents()

# ╔═╡ 375a0ed2-65ee-4c94-927d-ca14adf1833b
...
julia_version = "1.9.3"
manifest_format = "2.0"
project_hash = "19674bffae42096f69b69b7adf8969179293580d"

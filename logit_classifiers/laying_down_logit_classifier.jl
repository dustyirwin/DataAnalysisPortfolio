...
begin
	using PlutoUI
	using CSV, DataFramesMeta, Plots
	using GLM, StatsBase, MLJBase
end

# ╔═╡ bb972d93-32f6-47f8-bf00-dd5dc274950d
md"""
# "Laying Down?" Binomial Logit Regression Model
"""

# ╔═╡ a7a984e3-84dd-435e-a1fe-6121711b32d7
df = CSV.File("data/activity.csv", normalizenames=true) |> DataFrame

# ╔═╡ 13e98d6a-0a8b-4ff5-aab0-ebe28adf846d
describe(df)

# ╔═╡ a91b7347-aac4-4015-b2fa-664016475360
X, y = df.Acc_vertical_, df.LyingDown

# ╔═╡ 3252d1e1-2a65-40b9-86ac-b99119e08cee
countmap(y)

# ╔═╡ 78885e09-12da-42bc-82a9-0d18e10b95fb
clf = glm(@formula(y ~ X), DataFrame(X=X,y=y), Binomial(), ProbitLink())

# ╔═╡ 6e0707b4-ccbb-49c4-a027-081f908812e7
ŷ = [ x < 0.5 ? 0 : 1 for x in clf.model.rr.mu ]

# ╔═╡ 4016a997-ab71-425b-951f-d3d9cb42f6e5
# Manual calculation
true_pos,
false_pos,
true_neg,
false_neg = let
	...
	for (ŷ,y) in itr
		# checking for true pos
		push!(true_pos, ŷ == y && ŷ == 1 ? 1 : 0)

		# checking for false pos
		push!(false_pos, ŷ != y && ŷ == 1 ? 1 : 0)

		# checking for true negatives
		push!(true_neg, ŷ == y && ŷ == 0 ? 1 : 0)

		# checking for false negatives
		push!(false_neg, ŷ != y && ŷ == 0 ? 1 : 0)
	end
...
# ╔═╡ 36874837-8ef1-4e47-9cba-b5cf7b8fed3c
MLJBase.ConfusionMatrix()(ŷ, y)

# ╔═╡ 918bb427-ad3c-4336-977c-e6785d62760a
precision = true_pos / (true_pos + false_pos)

# ╔═╡ d07411a8-ecf3-480d-b35f-faf513787a97
recall = true_pos / (true_pos + false_neg)

# ╔═╡ b97e353f-adf0-4001-ad07-bd68de6ef46d
...
# ╔═╡ eb45fb93-5038-4d71-ad8d-3ab936bd0a55
false_pos_rate = false_pos / (true_pos + false_neg)

# ╔═╡ a1e55e31-c8e9-4278-a5eb-e38e7b100e37
...
julia_version = "1.9.3"
manifest_format = "2.0"
project_hash = "db1ee56566ed681f279583f2192d8f996576622e"

...
md"""# NBA Player 5yr Data - Gaussian Naive Bayes Classifier

Creating a Naive-Bayes classifer to predict who will last more than 5yrs in the NBA.
"""

# ╔═╡ a47c4865-b194-4193-b14a-b8937a270892
data_desc = CSV.File("../_data/nba-data-description.csv") |> DataFrame
...
# ╔═╡ 07b31155-a178-4293-93f0-99c775da2685
md" ## Gaussian NB Model"

# ╔═╡ 0d68bfff-8b43-401f-ae09-6832d9df3c03
model = @load GaussianNBClassifier pkg=NaiveBayes

# ╔═╡ 32f07989-3367-4959-bcde-382d5f99c618
md""" ## Results

The model shows good predictive power with a precision score of 0.84 and f1 score of 0.71.  
"""

# ╔═╡ d2fd616d-285b-499b-b6c2-562b85df597a
md"""
# Appendix A - Data
"""

# ╔═╡ 56be75dd-e8a4-497e-a227-8261ed35beac
data = CSV.File("../_data/extracted_nba_players.csv") |> DataFrame
...
cleaned_data = let
	...
	#df.target_5yrs = df.target_5yrs .+ 1
	df
end

# ╔═╡ 5cd6342d-0764-40d2-a1b9-74feebf4d54f
cleaned_data.target_5yrs |> countmap

# ╔═╡ dbb415bf-7a1b-4275-8b2c-9320e827b7e1
train, test = partition(cleaned_data, 0.8, rng=42, 
	stratify=cleaned_data.target_5yrs
)

# ╔═╡ 31839800-6149-410d-beb9-67158d273994
Xtrain, ytrain = select(train, Not(:target_5yrs)), train.target_5yrs
...
_X = select(_Xtrain, names(_Xtrain));
...
Xtest, ytest = select(test, Not(:target_5yrs)), test.target_5yrs
...
# ╠═╡ show_logs = false
p = MLJ.predict(mach, select(_Xtest, names(_Xtest)))

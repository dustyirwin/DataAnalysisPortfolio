...
df = let
	df = CSV.File("data/Churn_Modelling.csv", normalizenames=true) |> DataFrame
...
begin
	...
	y = coerce(ytest, OrderedFactor)
end;

# ╔═╡ 4345ae8a-7a06-4aaa-9686-bc92ff492b7f
balanced_accuracy(ŷ,y), accuracy(ŷ,y), precision(ŷ,y), recall(ŷ,y), f1score(ŷ,y)
...
julia_version = "1.9.3"
manifest_format = "2.0"
project_hash = "6255fcff189a6779e52dec95c7b1f2f4ccd4b7c2"

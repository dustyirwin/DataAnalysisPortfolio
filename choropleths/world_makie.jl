...
# ╔═╡ 73804b22-08d4-4f9f-a9f7-728b8f3f44b9
using GeoJSON, GeoMakie, Makie, CairoMakie, PlutoUI

# ╔═╡ 5714d781-df41-4c49-b84b-98df7aa03f48
md"""
# World Choropleth w/ CairoMakie & GeoMakie
"""

# ╔═╡ de137917-c1fa-47d1-af98-0a22e1f07c8a
md"""
Longitude: $(@bind lon PlutoUI.RangeSlider(-180:5:180, show_value=true)) Latitude: $(@bind lat PlutoUI.RangeSlider(-90:5:90, show_value=true))

"""

# ╔═╡ 50ba3248-1d50-44c6-9620-4f0a107df43f
md"""
# Appendix A
"""

# ╔═╡ 38c1134a-8c5d-4216-99cf-edf588bd6528
function default_fig()
    Figure(
        resolution = (1920, 1080), 
        fontsize = 30,
        figure_padding = (75, 75, 75, 75)
    )
end

# ╔═╡ b4580c87-5aa4-4bb9-926c-0a5e0128f59a
xtickformat = values -> [f(value) for value in values]

# ╔═╡ 71724778-05c6-4b7c-9d3e-2e4512371908
...
# ╔═╡ c92af7e1-575d-44d9-91dc-e17ad09b7da6
...
# ╔═╡ 20377598-a939-4b5c-a63c-a14a6826ec1b
begin
	fig = default_fig()
	ax = Axis(
	    fig[1, 1],
	    title = L"\text{The World, By Land}",
	    limits = (lon[begin], lon[end], lat[begin], lat[end]),
	    xticks = lon[begin]:40:lon[end],
	    yticks = lat[begin]:20:lat[end],
...
# ╔═╡ 3ac1561b-4c36-4547-b07d-14316d0b723d
begin
url = "https://raw.githubusercontent.com/nvkelso/natural-earth-vector/master/geojson/"
landmass = download(url * "ne_50m_land.geojson") |> GeoJSON.read
end

# ╔═╡ f42b9915-fe43-4ed8-b487-6ab6436f6f89
begin
	poly!(ax, landmass, color = colorant"gray50")
	fig
end

# ╔═╡ 6ce0b1f8-4a0d-4eca-8f7d-1b5c7cc84412
md"""
# Appendix B
"""

# ╔═╡ 0d076515-eb52-4561-9373-7c247c380be7
space = "<br><br><br>" |> HTML

# ╔═╡ 4a6b2733-9fe4-45be-b559-d27c8a787d22
...
# ╔═╡ a83dc9d5-ad7f-4031-a467-7675df0f0dea
PlutoUI.TableOfContents()

# ╔═╡ 861941e8-c105-41de-aefb-c185ce3b6668
...
manifest_format = "2.0"
project_hash = "cee8ea251aea9d12a91f228ca6112ad2cae8740a"
...
git-tree-sha1 = "100c0fd4e8e8d2130814307c8d231112ac6922fa"
